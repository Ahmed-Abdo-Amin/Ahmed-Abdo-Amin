...
<a href="https://www.credly.com/earner/earned" target="blank"><img align="center" src=".\Images_pre\credly.png" alt="" height="80" width="40" /></a>
...
- [US Federal Campaign Finance Data 1990–2016 Analysis Project](https://github.com/Ahmed-Abdo-Amin/USFederalCampaignFinanceData1990_2016AnalysisProject) | In my previous role, I was responsible for designing, implementing, and enhancing a Spark application to address specific inquiries using a given dataset. These inquiries included analyzing the evolution of individual contributions for each course over time, examining the impact of presidential election years versus midterm election years on contributions, and investigating how the industry or ideology of the donor influences individual contributions. Through my work, I aimed to provide valuable insights and facilitate a deeper understanding of these topics.
...
- [Hospitals Analysis project](https://github.com/Ahmed-Abdo-Amin/Five-PowerBI-Projects-for-Medicine/blob/main/Hospitals%20Analysis%20Dashboard) | We used confirmed, recovered, and death datasets for all hospitals in all countries. By using the PowerBI tool, we explored useful statistical information to know the highest rate of confirmed, recovered, and dead countries in hospitals.
- [Pharmaceutical Sales Analysis project](https://github.com/Ahmed-Abdo-Amin/Five-PowerBI-Projects-for-Medicine/blob/main/pharmaceutical-sales-analysis)| We analyzed a global pharmaceutical manufacturing company's raw sales data and gained meaningful insights. By using the PowerBI tool, we built a data model where dimensions and facts are separated by the provided data is in a single table format, and then they are linked together by logical relationships to form a star schema. So we extracted useful information by analyzing pharmaceutical sales, distributor and customer information, and sales team performance.
- [COVID 2019 Analaysis (Top 10 Asian Countries) project](https://github.com/Ahmed-Abdo-Amin/Five-PowerBI-Projects-for-Medicine/blob/main/COVID%202019%20Analysis%20(Top%2010%20Asian%20Countries))| We analyzed the COVID 2019 dataset by using the Power BI tool, so we extracted the top 10 Asian countries for the highest cases and death rates, as well as the median age and total deaths by country.
